...
<!-- Datepicker -->
	...
	{{ HTML::script('js/demonstration.min.js') }}
...
function refreshNotif() {
	           $.ajax({
                   ...
                   $(".notif-ul").html(obj.actions);
                   $("#notifcount").html(obj.actionscount);

                   if(obj.actionscount > 0) {
                   	  $(".notifcount").show('slow');
                   }
...
<body class="theme-{{ Auth::User()->theme }}">
     ...
     <div id="navigation" class="navbar-fixed-top">
		<div class="container-fluid">
			<a href="{{ URL::to('home') }}" id="brand">ECG PEREIRE</a>
			<ul class='main-nav'>
				<li class='active'>
					<a href="{{ URL::to('home') }}">
						<span><i class="glyphicon-home"></i> Acceuil</span>
					</a>
				</li>
				<li>
					<a href="{{ URL::to('contrat') }}"  class='dropdown-toggle'>
						<span><i class="glyphicon-vcard"></i> Contrat</span>
						
					</a>
					
				</li>
				<li>
					<a href="{{ URL::to('demande') }}"  class='dropdown-toggle'>
						<span><i class="glyphicon-circle_question_mark"></i> Mes demandes</span>
				...
				<li>
					<a href="#" data-toggle="dropdown" class='dropdown-toggle'>
						<span><i class="glyphicon-inbox"></i> Messagerie</span>
						<span class="caret"></span>
					</a>
					<ul class="dropdown-menu">
						<li>
							<a href="{{ URL::to('mail') }}"><i class="icon-envelope"></i> Boite e-mail</a>
						</li>
						<li>
							<a href="{{ URL::to('chat') }}"><i class="glyphicon-chat"></i> Chat en ligne</a>
						</li>
			...
			<div class="user">
				<ul class="icon-nav">
					...
					<li class='dropdown'>
						<a href="#" class='dropdown-toggle' data-toggle="dropdown"><i class="glyphicon-globe_af"></i><span class="label label-lightred notifcount" id="notifcount">10</span></a>
						<ul class="dropdown-menu pull-right message-ul notif-ul">
							
							<li>
								<a href="{{ URL::to('chat') }}" class='more-messages'>Voir touts les notifications <i class="icon-arrow-right"></i></a>
							</li>
						</ul>
					</li>
