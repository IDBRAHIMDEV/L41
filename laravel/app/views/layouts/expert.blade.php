...
<body class="theme-{{ Auth::User()->theme }}">
     ...
     <div id="navigation" class="navbar-fixed-top">
		<div class="container-fluid">
			...
			<ul class='main-nav'>
				<li>
					<a href="{{ URL::to('expert') }}"  class='dropdown-toggle'>
						<span><i class="glyphicon-conversation"></i></i> Chat</span>
					</a>
				</li>
				<li>
					<a href="{{ URL::to('remboursement') }}"  class='dropdown-toggle'>
						<span><i class="glyphicon-euro"></i></i> Remboursement</span>
					</a>
				</li>
