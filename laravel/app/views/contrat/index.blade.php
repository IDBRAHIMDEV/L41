               ...
               <div class="row-fluid">
               	   <div class="span12" >
						...
						<ul class="tiles tiles tiles-center nomargin" >
						     ...
						     <li class="long">
								<img src="{{ URL::asset($contrat->gamme->compagnie->chemin) }}" alt="">
							</li>
						   ...
						   @endif
							...
							<li class="  teal">
								<a href="#" rel="tooltip" data-original-title="Gamme & formule"><span><i class="icon-bookmark-empty"></i></span><span class="name">{{ $contrat->gamme->libelle }}</span></a>
							</li>
										...
										<div class="row-fluid">
											...
											<div class="span10">
												  <dl class="dl-horizontal">
												    <dt>PRENOM </dt>
											        <dd>{{ Auth::User()->prenom }}</dd>
											        <dt>NOM </dt>
											        <dd>{{ Auth::User()->nom }}</dd>
											        <dt>REGIME</dt>
											        <dd>{{ Auth::User()->regime }}</dd>
											        <dt>NAISSANCE</dt>
											        <dd>{{ date("d/m/Y",strtotime(Auth::User()->datenaissance)) }}</dd>
